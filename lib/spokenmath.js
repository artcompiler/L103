            ...
            switch (node.op) {
              ...
              default:
                if (visit.name !== "normalizeLiteral" && visit.name !== "sort") {
                  node = newNode(_model.Model.VAR, ["INTERNAL ERROR Should not get here. Unhandled node operator " + JSON.stringify(node)]);
                  console.trace();
                }
                break;
            }
