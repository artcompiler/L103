...
var transform = function () {
  ...
  function inData(node, options, resume) {
    ...
    if (node.elts.length === 0) {
      ...
      visit(node.elts[0], options, function (err1, val1) {
        var rating = [];
        var input = options.data && Object.keys(options.data).length !== 0 && isArray(options.data) ? options.data : val1;
  ...
  }, _defineProperty(_table, "IGNORE-ORDER", ignoreOrder), _defineProperty(_table, "IGNORE-COEFFICIENT-ONE", ignoreCoefficientOne), _defineProperty(_table, "COMPARE-SIDES", compareSides), _defineProperty(_table, "COMPARE-GROUPING", compareGrouping), _defineProperty(_table, "SET-DECIMAL-SEPARATOR", setDecimalSeparator), _defineProperty(_table, "SET-THOUSANDS-SEPARATOR", setThousandsSeparator), _defineProperty(_table, "FIELD", field), _defineProperty(_table, "ALLOW-THOUSANDS-SEPARATOR", allowThousandsSeparator), _defineProperty(_table, "ALLOW-INTERVAL", allowInterval), _defineProperty(_table, "IGNORE-TEXT", ignoreText), _defineProperty(_table, "IGNORE-TRAILING-ZEROS", ignoreTrailingZeros), _defineProperty(_table, "EVAL", evaluate), _defineProperty(_table, "CANCEL", cancel), _defineProperty(_table, "INTEGRATE", integrate), _defineProperty(_table, "DIFF", diff), _defineProperty(_table, "COLLECT", collect), _defineProperty(_table, "APART", apart), _defineProperty(_table, "MATCH", match), _defineProperty(_table, "CONCAT", concat), _defineProperty(_table, "AND", and), _defineProperty(_table, "OR", or), _defineProperty(_table, "LITERAL", literal), _defineProperty(_table, "SEED", seed), _defineProperty(_table, "STIMULUS", stimulus), _defineProperty(_table, "SOLUTION", solution), _defineProperty(_table, "FORMAT", format), _defineProperty(_table, "CHOICES", choices), _defineProperty(_table, "RESULT", result), _defineProperty(_table, "VARIABLE", variable), _defineProperty(_table, "PRECISION", precision), _defineProperty(_table, "DOMAIN", domain), _defineProperty(_table, "VAL", val), _defineProperty(_table, "KEY", key), _defineProperty(_table, "LEN", len), _defineProperty(_table, "ARG", arg), _defineProperty(_table, "DATA", inData), _defineProperty(_table, "IN", inData), _defineProperty(_table, "LAMBDA", lambda), _defineProperty(_table, "PAREN", paren), _defineProperty(_table, "APPLY", apply), _defineProperty(_table, "MAP", map), _defineProperty(_table, "DECIMAL", decimal), _defineProperty(_table, "GEN", formula), _defineProperty(_table, "DESMOS", desmos), _defineProperty(_table, "FORMULA", formula), _defineProperty(_table, "FORMULA-ESSAY", formulaEssay), _defineProperty(_table, "MCQ", mcq), _defineProperty(_table, "LATEX", latex), _defineProperty(_table, "TITLE", title), _defineProperty(_table, "INDEX", index), _defineProperty(_table, "NUMERIC", numeric), _defineProperty(_table, "VALUE", numeric), _defineProperty(_table, "NOTES", notes), _defineProperty(_table, "CONTEXT", context), _defineProperty(_table, "TEMPLATE", template), _defineProperty(_table, "PARAMS", params), _table);
  return transform;
}();
var render = function () {
  if (MATHJAX) {
