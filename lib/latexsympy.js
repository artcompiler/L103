  ...
  var define, module, exports;return function () {
    function r(e, n, t) {
      ...
      */
      ...
      var rules = exports.rules = { "data": {}, "words": { "\\infty": "oo", "\\pi": "pi", "e": "E", "Null": "None", "\\varnothing": "EmptySet" }, "types": { "integerPosNeg": ["(\\type{integerPosNeg})", "\\type{integer}", "-\\type{integer}"], "commonFraction": ["\\frac{\\type{integer}}{2}", "\\frac{\\type{integer}}{3}", "\\frac{\\type{integer}}{4}", "\\frac{\\type{integer}}{5}", "\\frac{\\type{integer}}{6}", "\\frac{\\type{integer}}{7}", "\\frac{\\type{integer}}{8}", "\\frac{\\type{integer}}{9}", "\\frac{\\type{integer}}{10}"], "simpleExpression": ["\\type{commonFraction}", "\\type{number}", "-\\type{number}", "-\\type{variable}", "\\type{variable}", "\\type{variable}\\type{variable}", "\\type{number}\\type{variable}"] }, "rules": { "\\ln{?}": ["ln(%2)"], "\\log{?}": ["log(%2,%1)"], "\\log_?{?}": ["log(%2,%1)"], "?!": ["factorial(%1)"], "\\frac{d^?}{d?^?}?": ["diff(%1, %2, %3)"], "\\int \\int ? d? d?": ["integrate %1 %2 %3"], "\\int_?^? ? d?": ["integrate(%3,(%4,%1,%2))"], "\\int ? d?": ["integrate(%1,%2)"], "\\lim_? ?": [{ "limit(%2, %1, '+-')": { "? \\rightarrow ?": "%1, %2", "? \\to ?": "%1, %2", "(?,?)": "%1, %2" } }], "\\sum_?^? ?": [{ "summation(%3,(%1,%2))": { "? = ?": "%1,%2" } }], "\\sin{?}": ["sin(%1)"], "\\cos{?}": ["cos(%1)"], "\\tan{?}": ["tan(%1)"], "\\cot{?}": ["cot(%1)"], "\\sec{?}": ["sec(%1)"], "\\csc{?}": ["csc(%1)"], "\\sin^{-1}{?}": ["asin(%1)"], "\\cos^{-1}{?}": ["acos(%1)"], "\\tan^{-1}{?}": ["atan(%1)"], "\\cot^{-1}{?}": ["acot(%1)"], "\\sec^{-1}{?}": ["asec(%1)"], "\\csc^{-1}{?}": ["acsc(%1)"], "\\sinh{?}": ["sinh(%2)"], "\\cosh{?}": ["cosh(%2)"], "\\tanh{?}": ["tanh(%2)"], "\\coth{?}": ["coth(%2)"], "\\operatorname{sech}{?}": ["sech(%6)"], "\\operatorname{csch}{?}": ["csch(%5)"], "\\sinh^{-1}{?}": ["asinh(%1)"], "\\cosh^{-1}{?}": ["acosh(%1)"], "\\tanh^{-1}{?}": ["atanh(%1)"], "\\coth^{-1}{?}": ["acoth(%1)"], "\\operatorname{sech}^{-1}{?}": ["asech(%6)"], "\\operatorname{csch}^{-1}{?}": ["acsch(%5)"], "\\frac{\\type{integerPosNeg}}{\\type{integerPosNeg}}": ["Rational(%1,%2)"], "\\type{integerPosNeg}\\div\\type{integerPosNeg}": ["Rational(%1,%2)"], "\\type{integerPosNeg}\\times\\type{integerPosNeg}^{-1}": [{ "Rational(%1,%2)": { "?^?": "%1" } }], "\\type{integerPosNeg}^{-1}": ["Rational(1,%1)"], "\\frac{?}{?}": ["(%1/%2)"], "|?|": ["Abs(%1)"], "\\abs{?}": ["Abs(%1)"], "?^?": ["%1**%2"], "\\sqrt{?}": ["sqrt(%1)"], "\\sqrt[?]{?}": ["root(%1,%2)"], "-?": ["-%1"], "?\\degree": ["rad(%1)"], "?+?": ["(%1+%2)"], "?-?": ["(%1-%2)"], "?*?": ["(%1*%2)"], "?\\cdot?": ["(%1*%2)"], "?\\div?": ["(%1/%2)"], "?<?": ["Lt(%1,%2)"], "?\\le?": ["Le(%1,%2)"], "?>?": ["Gt(%1,%2)"], "?\\ge?": ["Ge(%1,%2)"], "?=?": ["Eq(%1,%2)"], "?\\ne?": ["Ne(%1,%2)"], "?_?": ["%1_%2"], "(\\type{simpleExpression})": ["%1"], "(?)": ["(%1)"], "? ?": ["(%1*%2)"], "?,?": ["%1,%2"], "?": ["%1"] } };
