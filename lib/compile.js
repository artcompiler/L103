...
var _main = require("mathjax-node/lib/main.js");

var mjAPI = _interopRequireWildcard(_main);
...
var transform = function () {
  ...
  function params(node, options, resume) {
    visit(node.elts[0], options, function (err1, val1) {
      var values = [];
      var params = options.data && options.data.params ? options.data.params : val1; // Use defaults.
      if (params) {
